<?php
	...
	$conf['servers'][0]['desc'] = 'MON';

	// Hostname or IP address for server.  Use '' for UNIX domain socket.
	// use 'localhost' for TCP/IP connection on this computer
	$conf['servers'][0]['host'] = '10.10.10.20';
	...
	// Display name for the server on the login screen
	$conf['servers'][1]['desc'] = 'SQL01';

	// Hostname or IP address for server.  Use '' for UNIX domain socket.
	// use 'localhost' for TCP/IP connection on this computer
	$conf['servers'][1]['host'] = '10.10.10.61';
	...
	// Display name for the server on the login screen
	$conf['servers'][2]['desc'] = 'SQL02';

	// Hostname or IP address for server.  Use '' for UNIX domain socket.
	// use 'localhost' for TCP/IP connection on this computer
	$conf['servers'][2]['host'] = '10.10.10.62';
	 ...
	 */
//	$conf['srv_groups'][0]['desc'] = 'LINUX_PROJECT';
